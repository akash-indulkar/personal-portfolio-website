...
export default function HeroSection() {
  const socialLinks = [
    {
      name: "GitHub",
      href: "https://github.com/harshil1712",
      icon: Github,
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/harshil1712/",
      icon: Linkedin,
    ...
    {
      name: "Twitter",
      href: "https://twitter.com/harshil1712",
      icon: Twitter,
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/channel/UCH23wspbeXjQ2Un0W66NT9g",
      icon: Youtube,
